        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-6">
              Crafting Outdoor
              <span className="block text-amber-600">Excellence Since 1999</span>
            </h2>
...
Production will occur in a purpose-built 500 m² workshop in Kitwe, with three branded retail showrooms in Kitwe, Chingola, and Lusaka. We aim to create an initial one hundred direct jobs in the wood seasoning, processing and retail facilities and an additional 200 indirect jobs in the supply chain. 
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105"
                onClick={() => window.location.href = '/story'}
              >
                Our Story
              </button>
              <button className="border-2 border-stone-900 text-stone-900 hover:bg-stone-900 hover:text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105">
                Design Services
              </button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg">
              <div className="text-3xl font-bold text-amber-600 mb-1">A+</div>
        ...
        <div>
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-bold text-stone-900 mb-6">
              Why Choose Outdoor Interiors
            </h3>
            <p className="text-xl text-stone-600 max-w-3xl mx-auto">
              Our commitment to excellence goes beyond just selling furniture. 
              We're dedicated to creating outdoor experiences that last a lifetime.
            </p>
          </div>
        ...
        <div className="mt-20 bg-white rounded-2xl p-8 md:p-12 shadow-lg">
          <div className="text-center">
            ...
            <blockquote className="text-2xl md:text-3xl font-light text-stone-900 mb-6 italic">
              Outdoor Interiors transformed our backyard into a resort-like oasis. 
              The quality and service exceeded all our expectations.
            </blockquote>
            <div className="flex items-center justify-center space-x-4">
              ...
              />
              <div>
                <div className="font-semibold text-stone-900">Sarah & Michael Chen</div>
                <div className="text-stone-600">Beverly Hills, CA</div>
              </div>
            </div>
          </div>
        </div>
